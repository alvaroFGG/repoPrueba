...
// Crea ahora una función empujarHeroe que reciba un argumento arrayHeroes (será un array) 
//y otro argumento nuevoHeroe (será un string) y empuje dentro de arrayHeroes el argumento nuevoHeroe.
...
// Crea ahora una función sacarHeroe que reciba un argumento arrayHeroes (será un array) 
//y saque de este array el último elemento (¡recuerda la sección de arrays del prework!).
function sacarHeroe(superheroes){
    superheroes.pop();
    return superheroes;
}
